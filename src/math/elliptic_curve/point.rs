...
mod tests {
    ...
    use crate::math::elliptic_curve::short_weierstrass::curves::test_curve_1::{
        TestCurve1, TestCurveQuadraticNonResidue, TEST_CURVE_1_MAIN_SUBGROUP_ORDER,
    };
    use crate::math::elliptic_curve::short_weierstrass::curves::test_curve_2::TestCurve2;
    use crate::math::field::element::FieldElement;
    use crate::math::unsigned_integer::element::U384;
    //use crate::elliptic_curve::curves::test_curve_2::TestCurve2;
    use crate::math::elliptic_curve::traits::{EllipticCurveError, IsEllipticCurve};
