...
impl Compress for ShortWeierstrassProjectivePoint<BLS12381Curve> {
    ...
    fn decompress_g1_point(
        ...
        let y =
            sqrt::select_sqrt_value_from_third_bit(y_sqrt_1.clone(), y_sqrt_2.clone(), third_bit);
        let point =
